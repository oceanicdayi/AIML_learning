...
# Hugging Face Hub >= 1.0 removed HfFolder, but some Gradio 4.x builds
# still import it during startup. Add a tiny compatibility shim before
# importing gradio so the Space can boot even if the runtime upgrades hub.
